package com.example.foryou_1.util
 ...
 * [DidYouKnowFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [DidYouKnowFragment.newInstance] factory method to
...
class DidYouKnowFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_did_you_know, container, false)
        ...
        //image
        val imageView = view.findViewById<ImageView>(R.id.image_view_did_you_know)
    ...
    companion object {
         ...
         * @return A new instance of fragment DidYouKnowFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            DidYouKnowFragment().apply {
